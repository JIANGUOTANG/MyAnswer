 ...
 */
public class MyCircleRadioButton extends View implements Checkable {
    private boolean mChecked;
    private Context mContext;
    public MyCircleRadioButton(Context context) {
        this(context, null);
    }
    ...
    public MyCircleRadioButton(Context context, AttributeSet attrs) {
    ...
    public MyCircleRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        mContext = context;
        init(attrs);
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(width/2,height/2,width/2-mStrokeWidth-2, paint);
        drawText(canvas);
    }
