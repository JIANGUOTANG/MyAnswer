...
import com.example.jian.myanswer.util.DensityUtil;
...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSuccessText = array.getString(R.styleable.LoadingView_success_text);

        mLoginText = array.getString(R.styleable.LoadingView_loading_text  );
